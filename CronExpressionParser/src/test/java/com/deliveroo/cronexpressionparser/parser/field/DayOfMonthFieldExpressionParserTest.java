...
import static com.deliveroo.cronexpressionparser.parser.field.DayOfMonthFieldExpressionParser.DAY_OF_MONTH;

public class DayOfMonthFieldExpressionParserTest extends TestCase{
    public static final String TEST1 = "1,15";
    public static final String TEST2 = "1,,15";
    public static final String TEST3 = "*/15";

    @InjectMocks
    DayOfMonthFieldExpressionParser dayOfMonthFieldExpressionParser;
    ...
    public void testValidateFieldExpression() {
        try {
            dayOfMonthFieldExpressionParser.validateFieldExpression(TEST1);
    ...
    public void testValidateFieldExpressionWithEx() {
        try {
            dayOfMonthFieldExpressionParser.validateFieldExpression(TEST2);
    ...
    public void testParseFieldExpression() throws ExpressionValidationException {
        String output = dayOfMonthFieldExpressionParser.parseFieldExpression(TEST1);
        Assert.assertEquals(output, DAY_OF_MONTH + StringUtils.ARROW + "1 15");
    }

    public void testParseAsteriskValue() {
        String output = dayOfMonthFieldExpressionParser.parseAsteriskValue();
        Assert.assertNotNull(output);
    }

    public void testParseStepValues() {
        String output = dayOfMonthFieldExpressionParser.parseStepValues(TEST3);
        Assert.assertNotNull(output);
    }
}